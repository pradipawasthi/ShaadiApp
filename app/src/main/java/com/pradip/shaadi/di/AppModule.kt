...
import com.pradip.data.db.ShaadiDatabase.Companion.DATABASE_NAME
...
object AppModule {
    ...
    @Singleton
    @JvmStatic
    fun provideRoomDb(@ApplicationContext context: Context) = Room.databaseBuilder(context, ShaadiDatabase::class.java, DATABASE_NAME)
